...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 13 2024 г., 22:12
...
CREATE TABLE `orders` (
  ...
  `status` enum('Новый','Принят','Отменён') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Новый',
...
(29, 5, 1, 1, 'Новый', '1', '2024-11-13 19:06:52');
